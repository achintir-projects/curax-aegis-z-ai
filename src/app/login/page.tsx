    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-white flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Curax AI</h1>
          <p className="text-gray-600">Secure Healthcare Platform</p>
        </div>
          ...
          <Tabs defaultValue="login" className="w-full">
            ...
            <TabsContent value="login">
              <CardHeader>
                ...
                <CardDescription>
                  Sign in to your account to access the AI healthcare platform
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <TabsContent value="register">
              <CardHeader>
                ...
                <CardDescription>
                  Join Curax AI to access advanced healthcare diagnostics
                </CardDescription>
              </CardHeader>
              <CardContent>
